...
describe("POST /api/contacts/contactId/addresses", () => {
  ...
  it("should be able to new create address", async () => {
  ...
  it("should reject create new address if data invalid", async () => {
    const contact = await ContactTest.get();
    const response = await supertest(web)
      .post(`/api/contacts/${contact.id}/addresses`)
      .set("X-API-TOKEN", "test")
  ...
  it("should reject create new address if contact invalid", async () => {
    const contact = await ContactTest.get();
    const response = await supertest(web)
...
describe('PUT /api/contacts/"contactId/addresses/:addressId', () => {
  ...
  it("should reject update if address is invalid", async () => {
    const contact = await ContactTest.get();
    const address = await AddressTest.get();
  ...
  it("should reject update if address i not found", async () => {
    const contact = await ContactTest.get();
    const address = await AddressTest.get();
  ...
  it("should reject update if contact i not found", async () => {
    const contact = await ContactTest.get();
    const address = await AddressTest.get();
...
describe("DELETE /api/contacts/:contactId/addresses/:addressId  ", () => {
  ...
  it("should reject remove if address address is not found", async () => {
    const contact = await ContactTest.get();
    const address = await AddressTest.get();
  ...
  it("should reject remove if address contact is not found", async () => {
    const contact = await ContactTest.get();
    const address = await AddressTest.get();
